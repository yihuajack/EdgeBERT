...
for ENTROPY in $ENTROPIES; do
    ...
    python ../examples/masked_run_highway_glue.py --model_type albert \
      --model_name_or_path ./saved_models/masked_albert/QNLI/bertarized_two_stage_pruned_0.6 \
      --task_name QNLI \
      --do_eval \
      --do_lower_case \
      ...
      --output_dir ./saved_models/masked_albert/QNLI/bertarized_two_stage_pruned_0.6  \
